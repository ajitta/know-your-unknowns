...
description: >
  ...
  is made, and when the user says "implementation notes", "이탈 기록", "임플 노트",
  "log deviations", or asks where/why the work diverged from the plan.
argument-hint: "[init | show | <기록할 내용>]"
---

# Implementation Notes — 이탈 지점 기록
