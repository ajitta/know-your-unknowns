...
- 현재 상태로 측정된 것은 **한국어 축뿐**이다:
  [trigger-eval-v0.5.1.md](trigger-eval-v0.5.1.md), 한국어 문구를 뺀 description으로 11/11 정발화
  (기계 판정, 타임아웃 0). 영어 11건·네거티브 4건·behavior 3건, 그리고 위 두 과발화 항목은
  여전히 미측정이다.
